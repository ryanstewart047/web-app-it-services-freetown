...
export default function BannerPopup() {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[70] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl transform transition-all duration-300 relative overflow-hidden">
        {/* Close Button */}
        <button
          onClick={closeBanner}
          className="absolute top-4 right-4 w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center z-10 transition-colors duration-200"
        >
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary/90 transition-all duration-200 hover:scale-105 font-medium text-center flex-1"
              onClick={closeBanner}
            >
              Book Now
            </a>
            <button
              onClick={closeBanner}
              className="border border-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 font-medium flex-1"
            >
              Maybe Later
            </button>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            ...
            <div className="flex space-x-4 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full flex items-center justify-center hover:from-purple-600 hover:to-pink-600 transition-all duration-200"
              >
