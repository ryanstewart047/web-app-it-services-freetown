  ...
  const loadRealTimeData = async () => {
    ...
    try {
      ...
      const analyticsData: AnalyticsData = {
        visitors: { totalVisitors: 0, uniqueVisitors: 0, totalSessions: 0, topPages: [], trafficSources: [] },
        forms: { totalSubmissions: formSubmissions.length, overallConversionRate: 0, recentSubmissions: [] },
        errors: { totalErrors: 0, pendingErrors: 0, topErrors: [] },
        financial: { revenue: { monthly: 0, growth: { monthly: 0 } } }
      };
