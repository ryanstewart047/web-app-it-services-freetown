      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            priceRange: 'Le 100 - Le 10,000',
            currenciesAccepted: 'NLE, USD',
            ...
            hasOfferCatalog: {
              ...
              itemListElement: [
                {
                  '@type': 'Product',
                  name: 'HP ZBook 15V G5 15.6" FHD Core i5-8850H Laptop',
                  description: 'HP ZBook 15V G5 with Core i5-8850H, 8GB RAM, 512GB SSD, NVIDIA Quadro P600 4GB, Windows 11 Pro',
                  brand: {
                    '@type': 'Brand',
                    name: 'HP',
                  },
                ...
                {
                  '@type': 'Product',
                  name: 'Dell 5590 Core i7 8th Gen Laptop',
                  description: 'Dell 5590 with Core i7 8th Gen, 8GB RAM, 250GB SSD, Windows 11',
                  brand: {
                    '@type': 'Brand',
                    name: 'Dell',
                  },
                ...
                {
                  '@type': 'Product',
                  name: 'HP 250 G5 Notebook PC Intel Core i3',
                  description: 'HP 250 G5 with Intel Core i3-6200U, 8GB RAM, 250GB HDD',
                  brand: {
                    '@type': 'Brand',
                    name: 'HP',
                  },
                ...
                {
                  '@type': 'Product',
                  name: 'Western Digital PC SN530 NVMe SSD 256GB',
                  description: 'WD PC SN530 NVMe SSD, 256GB, M.2 2280 form factor',
                  brand: {
                    '@type': 'Brand',
