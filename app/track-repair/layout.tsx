...
export const metadata: Metadata = {
  ...
  description: 'Track your device repair status in real-time. Get instant updates on your computer or mobile repair at BridgeTech IT Services.',
  keywords: ['track repair', 'repair status', 'device repair tracking', 'repair progress Freetown'],
  openGraph: {
    title: 'Track Your Repair | BridgeTech IT Services',
