      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
         ...
         <div className="flex items-center gap-3 flex-wrap">
           <button 
             ...
             className="bg-red-600 hover:bg-red-500 text-white font-bold text-xs uppercase tracking-widest py-3 px-6 rounded-lg transition-all shadow-lg shadow-red-500/20 flex items-center gap-2 border border-red-500/50"
           >
           ...
           <button 
             ...
             className="bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold text-xs uppercase tracking-widest py-3 px-5 rounded-lg transition-all border border-slate-700 flex items-center gap-2"
           >
